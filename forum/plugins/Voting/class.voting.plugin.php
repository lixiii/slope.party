...
class VotingPlugin extends Gdn_Plugin {
   ...
   public function DraftsController_BeforeDiscussionFilters_Handler($Sender) {
        $this->DiscussionsController_BeforeDiscussionFilters_Handler($Sender);
   }
